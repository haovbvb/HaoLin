...
{
    self.HSPSegmentedControl = [[HSPSegmentedControl alloc] initWithOriginY:64 Titles:@[@"全部订单", @"待收货", @"已发货", @"已收货"] delegate:self] ;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    waitVc.orderId = [order.order_id intValue];
