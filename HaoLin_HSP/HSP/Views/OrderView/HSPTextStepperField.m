...
@implementation HSPTextStepperField
...
- (void)initializeControl {
    ...
    CGSize BFStepperButton = CGSizeMake(20, self.frame.size.height);
...
//    [self.minusButton setImage:[UIImage imageNamed:@"UIStepperMinus"] forState:UIControlStateNormal];
    [self.minusButton setBackgroundColor:[UIColor clearColor]];
