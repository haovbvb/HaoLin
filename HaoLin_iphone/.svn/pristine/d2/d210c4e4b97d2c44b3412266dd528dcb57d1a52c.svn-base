...
@property (nonatomic, weak) IBOutlet UIImageView *imageViewForKindId;
...
-(void)setSelectedHanDankind:(NSDictionary *)selectedHanDankind
{
    ...
    int kindId = [[selectedHanDankind objectForKey:@"kindId"]intValue];
    NSString *imageName = [NSString stringWithFormat:@"MQLKindId_%d@2x.png", kindId];
    self.imageViewForKindId.image = [UIImage imageNamed:imageName];
