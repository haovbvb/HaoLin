...
-(void)awakeFromNib
{
    ...
    UIImage *image =[UIImage imageNamed:@"MDLmap1@2x"];
    [self.MapButton setBackgroundImage:image forState:UIControlStateNormal];
//    [self.xuanzebutton addTarget:self action:@selector(PUSH:) forControlEvents:UIControlEventTouchUpInside];
...
//选择物品VC
- (IBAction)pushxz:(id)sender {
    
    self.xuanzeneirong.text=nil;
