...
-(void)makeBlockEecute:(void(^)(JZDScrollView *scroll))blockScroll withImageArray:(NSMutableArray *)array
{
    ...
    for(int i=0;i<array.count;i++){
        JZDScrollView *scroll=[[JZDScrollView alloc] initWithFrame:CGRectMake(0, 0,320 , win.frame.size.height)];
        UIImageView *imageView=[[UIImageView alloc] initWithFrame:CGRectMake(i*320, 0, 320, win.frame.size.height)];
        imageView.image=[(JZDImageView *)array[i] image];
