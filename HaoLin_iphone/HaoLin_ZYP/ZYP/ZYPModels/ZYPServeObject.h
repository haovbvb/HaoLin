...
@property (nonatomic, strong)NSString *goodsinfo;//数组
@property (nonatomic, strong)NSString *cat_id;//数组
@property (nonatomic, strong)NSString *cat_name;//数组
@property (nonatomic, strong)NSString *delivery_address;//常用地址
