...
@interface ZYPOrderDetailVC ()
{
    ...
    ZYPEntityOrderDetailView *entityview;
}
...
- (void)viewDidLoad
{
    ...
    entityview = [[[NSBundle mainBundle] loadNibNamed:@"ZYPEntityOrderDetailView" owner:self options:nil] lastObject];
    entityview.detailV = self;
    entityview.btn.hidden = YES;
