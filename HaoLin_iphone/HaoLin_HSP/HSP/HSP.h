...
// 我发起的聚会
#define myPartyListUrl    @"http://t9.wxwork.cn/index.php?m=home&c=space&a=mySendGroup&user_id=%@&type=0&page=%d&tokenid=%@"
// 我参与的聚会
#define joinPartyListUrl  @"http://t9.wxwork.cn/index.php?m=home&c=space&a=myJoinGroupList&user_id=%@&type=0&page=%d&tokenid=%@"
// 聚会详情
#define detailPartyUrl    @"http://t9.wxwork.cn/index.php?m=home&c=space&a=myGroupOneApply&user_id=%@&group_id=%@&page=%@&tokenid=%@"
// 发布聚会
#define postPartyUrl      @"http://t9.wxwork.cn/index.php?m=home&c=group&a=addGroup"

// 查看报名我的活动的同意状况
#define CheckAgreeParty   @"http://t9.wxwork.cn/index.php?m=home&c=space&a=myGroupOneApply&user_id=%@&group_id=%@&page=%@&tokenid=%@"

#define PublishPartyActivity @"http://t9.wxwork.cn/index.php?m=home&c=group&a=addGroup"

//
#define isApplyBtnOkUrl      @"http://t9.wxwork.cn/index.php?m=home&c=group&a=checkUserIsApply&group_id=%@&user_id=%@&tokenid=%@"
